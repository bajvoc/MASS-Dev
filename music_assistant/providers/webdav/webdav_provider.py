"""
WebDavProvider is a simple implementation of a MusicProvider that uses WebDAV to access music files.

This provider allows you to browse a WebDAV server, read metadata from audio files, and stream
...
from .constants import AUDIO_FILES, IGNORE_FOLDERS, PLAYLIST_FILES, WEB_DAV
